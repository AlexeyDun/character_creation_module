...
def attack(char_name: str, char_class: str) -> str:
    """Функция выводит данные об уроне противника."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция выводит данные о блокировании урона."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция выводит данные о применении спец умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция активирует тренировку.
    Позволяет игроку проверить умения персонажа.
    """
    if char_class == 'warrior':
